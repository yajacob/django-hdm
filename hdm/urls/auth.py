...
urlpatterns = [
    ...
    url(r'^password_reset/done/$', auth_views.password_reset_complete, {'template_name': 'registration/password_reset_complete.html'},
        name='password_reset_complete'),
    url(r'^signup/$', SignupView.as_view(), name='signup'),
    url(r'^signup_home/$', SignupHomeView.as_view(), name='signup_home'),
    url(r'^password_change/$', ChangePassword.as_view(), name='password_change'),
]
